...
void Bitmap_Shrink(Struct_Bitmap_Data* FromBM, Struct_Bitmap_Data* ToBM, int Resize_To_X, int Resize_To_Y)
{
	...
	Old_Size_X = (DWORD)FromBM->Size_X;
	Old_Size_Y = (DWORD)FromBM->Size_Y;
	
	ToBM->Size_X = Resize_To_X;
	ToBM->Size_Y = Resize_To_Y;
	ToBM->Pixels = malloc(Resize_To_X * Resize_To_Y * BYTES_PER_PIXEL);

	uy = (BYTE*)FromBM->Pixels;
	ny = 0;
...
void Bitmap_Resize_Bilinear(Struct_Bitmap_Data* FromBM, Struct_Bitmap_Data* ToBM, int Resize_To_X, int Resize_To_Y)
{
	...
	From_Pixels = (unsigned int*)FromBM->Pixels;
	To_Pixels   = (unsigned int*)ToBM->Pixels;
